...
class Publisher():
    def __init__(self) -> None: 
        ...
        self.jpeg_quality = 50  # 0 to 100, higher is better quality, 96 is cv2 default
...
if __name__ == '__main__':
    ...
    try:
        while True:  # send images as stream until Ctrl-C
            ...
            msg.start = False
            msg.landmark_ids = []
            msg.robot_position = [0.0, 1.0]  # Ensure this is initialized with two elements
            msg.robot_stdev=[1.0,1.0,1.0]
            msg.text = ''
