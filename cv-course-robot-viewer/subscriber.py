...
import jsonpickle
class Subscriber():
    def __init__(self, port='tcp://100.64.0.2:5555') -> None:

        # pub/sub:
        #self.image_hub = imagezmq.ImageHub(open_port='tcp://100.64.0.1:5555', REQ_REP=False)
        self.image_hub = imagezmq.ImageHub(open_port=port, REQ_REP=False)
