...
class Message:
    ...
    #goal_position: np.array = field(default_factory=lambda: np.array([]))
    #point_to_plot: List = field(default_factory=lambda: [])
    goal_position: List = field(default_factory=lambda: [])
